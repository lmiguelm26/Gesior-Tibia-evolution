                        ...
                        <div id="Content" class="Content">
							...
							<div id="ThemeboxesColumn" >
                                <div id="RightArtwork">
                                    ...
                                    <img id="PedestalAndOnline" src="<?php echo $layout_name; ?>/images/global/header/pedestal.png" alt="Monster Pedestal Box"/>
                                </div>
                                <div id="Themeboxes">
                                    <div id="TopLvl">
                                        <h3 class="TopLvl_title">Top 5 Experience</h3>
                                        <?php $topLevel5 = $SQL->query('SELECT * FROM players WHERE deleted = 0 AND group_id = 1 AND account_id != 1 ORDER BY level DESC LIMIT 5'); ?>
                                        <?php $topLevel5->execute([]) ?>
                                        <?php $topLevel5 = $topLevel5->fetchAll(); ?>
                                        <?php $cont = 0 ?>
                                        <?php foreach ($topLevel5 as $key => $value) { ?>
                                        <?php 
                                            $cont++ ;
                                            $rankLevel = ''
                                        ?>
                                        <div class="tplevellayout">
                                            ...
                                            <?php if($cont == 1) {
                                                ...
                                                $rankLevel = 'secondlevel';
                                            } else if($cont == 3) {
                                                $rankLevel = 'thirdlevel';
                                            }
                                            ?>
                                            <?php if($rankLevel != "") { ?>
                                            <div><span class="<?= $rankLevel ?>"><span id="<?= $rankLevel ?>"></span></span></div>

                                            <div class="rankinglevel">
                                                <span class="<?= $rankLevel ?>"><span id="<?= $rankLevel ?>"></span></span>
                                            </div>
                                            <?php } ?>
                                        </div>
                                        <?php }?>
                                ...
                                <!-- premium theme box -->
                                            <style>
                                            .ribbon-double {
                                                background:url(./layouts/tibiacom/images/shop/ribbon-double.png) no-repeat;
                                                width: 80px;
                                                height: 80px;
                                                position:absolute;
                                                right: 0;
                                            ...
                                            <!-- Premium theme box -->
                                            <div id="PremiumBox" class="Themebox" style="background-image:url(./layouts/tibiacom/images/global/themeboxes/premium/premiumbox.gif);">
                                                <div id="doublePointsSelector">
                                                <div class="ribbon-double"></div>
                                            </div>
                                            ...
                                            <div class="Bottom" style="background-image:url(./layouts/tibiacom/images/global/general/box-bottom.gif);"></div>
                                            </div>
                                            <br>
                                        <div id="Themeboxes">
                                            <div id="TranslatorBox" class="Themebox" style="background-image:url(./layouts/tibiacom/images/themeboxes/translatorbox.gif)">
                                                <div id="google_translate_element" style="padding:34px;margin:-25px">
                                                    <script type="text/javascript">
